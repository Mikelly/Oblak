...
namespace Oblak.Migrations
{
    ...
    [Migration("20231016190836_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Oblak.Data.GuestToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Oblak.Data.PropertyUnit", b =>
                {
                    ...
                    b.Property<decimal>("BorTax")
                        .HasColumnType("decimal(18,2)");

                    b.Property<bool>("BorTaxYN")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Oblak.Data.MnePerson", b =>
                {
                    ...
                    b.Property<string>("ProviderJMBG")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Oblak.Data.SrbPerson", b =>
                {
                    ...
                    b.Property<string>("PropertyUnits")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("UnitCheckIn")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UnitCheckOut")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Oblak.Data.FiscalRequest", b =>
                {
                    b.HasOne("Oblak.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
