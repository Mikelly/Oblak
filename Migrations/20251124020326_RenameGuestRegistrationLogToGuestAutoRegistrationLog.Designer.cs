...
namespace Oblak.Migrations
{
    ...
    [Migration("20251124020326_RenameGuestRegistrationLogToGuestAutoRegistrationLog")]
    partial class RenameGuestRegistrationLogToGuestAutoRegistrationLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Oblak.Data.Computer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Oblak.Data.ComputerLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Oblak.Data.GuestAutoRegistrationLog", b =>
                {
                    ...
                    b.Property<string>("ExternalErrors")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
            ...
            modelBuilder.Entity("Oblak.Data.MneMupData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Oblak.Data.Partner", b =>
                {
                    ...
                    b.Property<int>("DefaultPaymentId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("UseEntryPointInGroup")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Oblak.Data.PaymentTransaction", b =>
                {
                    ...
                    b.Property<string>("MobileResponseJson")
                        .HasColumnType("NVARCHAR(MAX)");
            ...
            modelBuilder.Entity("Oblak.Data.ResTaxHistory", b =>
                {
                    ...
                    b.Property<DateTime?>("PrevCheckOut")
                        .HasColumnType("datetime2");

                    b.Property<decimal?>("PrevResFeeAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("PrevResTaxAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<int?>("PrevResTaxExemptionTypeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Oblak.Data.TaxPaymentType", b =>
                {
                    ...
                    b.Property<string>("TaxPaymentStatus")
                        .IsRequired()
                        .HasPrecision(450)
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Oblak.Data.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("IsCertRequired")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Oblak.Data.MnePerson", b =>
                {
                    ...
                    b.Property<Guid?>("ComputerCreatedId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("ResTaxExemptionTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ComputerCreatedId");

                    b.HasIndex("ResTaxExemptionTypeId");

                    b.HasIndex("ResTaxPaymentTypeId");

                    b.HasIndex("ResTaxTypeId");

                    b.ToTable("MnePersons", null, t =>
                        {
                            t.HasTrigger("trg_MnePersons_Delete");

                            t.HasTrigger("trg_MnePersons_Insert");

                            t.HasTrigger("trg_MnePersons_Update");
                        });
            ...
            modelBuilder.Entity("Oblak.Data.ComputerLog", b =>
                {
                    b.HasOne("Oblak.Data.Computer", "Computer")
                        .WithMany("ComputerLogs")
            ...
            modelBuilder.Entity("Oblak.Data.MnePerson", b =>
                {
                    b.HasOne("Oblak.Data.Computer", "Computer")
                        .WithMany("MnePersons")
                        .HasForeignKey("ComputerCreatedId");

                    b.HasOne("Oblak.Data.ResTaxExemptionType", "ResTaxExemptionType")
                        .WithMany()
                        .HasForeignKey("ResTaxExemptionTypeId");
                    ...
                    b.Navigation("ResTaxExemptionType");
            ...
            modelBuilder.Entity("Oblak.Data.Computer", b =>
                {
                    b.Navigation("ComputerLogs");

                    b.Navigation("MnePersons");
                });
