...
{
    /// <inheritdoc />
    public partial class AlterPersonListMne4 : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.Sql(@" 
                    ...
                    BEGIN
                        SELECT 
                            ...
                            -- ResidenceTaxAmount default vrijednost 1.00 kad o.MunicipalityId IS NULL
                            CAST(
                                CASE 
                                    -- Puni iznos 18+
                                    WHEN
